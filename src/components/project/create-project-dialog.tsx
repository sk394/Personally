...
const stepOrder: Array<StepType> = [
  'title',
  'description',
  'visibility',
  'invitations',
...
export function CreateProjectDialogHorizon({
  ...
  const [invitations, setInvitations] = React.useState<Array<InvitationInput>>([])
        ...
        {currentStep !== 'complete' && (
          <DialogHeader>
            ...
            <DialogDescription>
              ...
              {currentStep === 'invitations' && 'Invite people to collaborate'}
            </DialogDescription>
