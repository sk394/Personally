...
export function CreateLoanDialog({
  ...
  React.useEffect(() => {
    if (
      (formData.hasInterest || !formData.hasInterest) &&
  ...
  const handleSubmit = async () => {
    ...
    createLoanMutation.mutate({
      ...
      interestRate:
        formData.hasInterest && formData.interestRate
              ...
              >
                ...
                <div className="grid grid-cols-2 gap-3">
                  <button
                    type="button"
                    onClick={() =>
                      setFormData((prev) => ({ ...prev, type: 'borrowed' }))
                    }
                    className={cn(
                  ...
                  <button
                    type="button"
                    onClick={() =>
                      setFormData((prev) => ({ ...prev, type: 'lent' }))
                    }
                    className={cn(
                      'p-4 rounded-lg border-2 transition-all text-left',
                      formData.type === 'lent'
              ...
              <AnimatePresence>
                {visibleFields.dates && (
                  ...
                  >
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      <div className="space-y-2">
                        <Label htmlFor="loanDate" className="text-sm">
                          Loan Date *
                        </Label>
                        <div className="relative">
                    ...
                    {formData.hasInterest && (
                      ...
                      >
                        <Input
                          ...
                          className="pr-10"
                        />
                        <span className="absolute right-3 top-3 text-sm text-zinc-500">
                          %
                        </span>
                      </motion.div>
                    )}
