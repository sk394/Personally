const LiquidSvg = () => (
  ...
  >
    ...
    {/* Background liquid with text clip */}
    <g clipPath="url(#textClip)">
      ...
      <circle r="3" fill="#ffffff40">
        <animateMotion
          dur="6s"
          repeatCount="indefinite"
          path="M50,150 Q200,50 350,150 Q200,100 50,150"
        />
      </circle>
      <circle r="2" fill="#ffffff30">
        <animateMotion
          dur="8s"
          repeatCount="indefinite"
          path="M100,170 Q250,70 400,170 Q250,120 100,170"
        />
      </circle>
      <circle r="4" fill="#ffffff20">
        <animateMotion
          dur="5s"
          repeatCount="indefinite"
          path="M150,160 Q300,60 450,160 Q300,110 150,160"
        />
      </circle>
      <circle r="1.5" fill="#ffffff50">
        <animateMotion
          dur="7s"
          repeatCount="indefinite"
          path="M80,140 Q220,80 360,140 Q220,90 80,140"
        />
      </circle>
    </g>
  </svg>
...
export default function PersonallyLogo({
  width = 200,
  height = 100,
}: {
  width?: string | number
