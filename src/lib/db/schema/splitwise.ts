...
export const splitwiseSetting = pgTable(
  'splitwise_setting',
  {
...
export const balance = pgTable('balance', {
  ...
  fromUserId: text('from_user_id')
    .notNull()
    .references(() => user.id, { onDelete: 'cascade' }), // debtor
  toUserId: text('to_user_id')
    .notNull()
    .references(() => user.id, { onDelete: 'cascade' }), // creditor
...
export const settlement = pgTable('settlement', {
  ...
  fromUserId: text('from_user_id')
    .notNull()
    .references(() => user.id, { onDelete: 'cascade' }), // who paid
  toUserId: text('to_user_id')
    .notNull()
    .references(() => user.id, { onDelete: 'cascade' }), // who received
