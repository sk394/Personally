...
import { project, projectInvitation, projectMember, projectTemplate } from "@/lib/db/schema/project";
import { balance, expense, expenseSplit, settlement, splitwiseSetting } from "@/lib/db/schema/splitwise";
...
export const projectTemplatesRelations = relations(projectTemplate, ({ many }) => ({
    projects: many(project),
}));
...
export const projectInvitationsRelations = relations(projectInvitation, ({ one }) => ({
    project: one(project, {
...
// splitwise relations
export const splitwiseSettingsRelations = relations(splitwiseSetting, ({ one }) => ({
    project: one(project, {
