...
function SignupPage() {
  ...
  return (
    <div className="flex items-center justify-center bg-neutral-100 px-4 py-8 dark:bg-neutral-900">
      <div className="shadow-input mx-auto w-full max-w-sm rounded-none bg-white p-4 md:rounded-2xl md:p-6 dark:bg-black">
