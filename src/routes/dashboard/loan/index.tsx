...
function RouteComponent() {
  ...
  const borrowedLoans =
    allLoans?.filter((loan) => loan.type === 'borrowed') || []

  // live query for lent loans
  const lentLoans = allLoans?.filter((loan) => loan.type === 'lent') || []
    ...
    <Card className="border-dashed">
      <CardContent className="flex flex-col items-center justify-center py-12">
        ...
        <p className="text-muted-foreground text-center mb-4">
          Start tracking money you've borrowed or lent to others
        </p>
        <Button>
