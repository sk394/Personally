        ...
        return (
            <div className="flex flex-col gap-4">
                <AnimatePresence>
                    ...
                    >
                        <form.AppField
                            ...
                            listeners={{
                                onChange: ({ value }: { value: 'borrowed' | 'lent' }) => setLoanType(value),
                            }}
                        >
                            {(field) => (
                                <field.ChoiceCardField
                                    ...
                                    options={[
                                        ...
                                        },
                                        {
                                            ...
                                            backgroundColor: 'bg-green-50 dark:bg-green-950/30 shadow-sm',
                                        },
                                    ]}
                                />
                            )}
                ...
                <AnimatePresence>
                    ...
                    >
                        <div className="mt-1 ">
                            <form.AppField name="hasInterest"
                                listeners={{
                                    onChange: () => {
                                    ...
                                    <form.AppField name="interestRate">
                                        {(field) => (
                                            <div className="space-y-1">
                                                ...
                                                />
                                                <p className="text-xs text-muted-foreground pl-1">
                                                    {field.state.value ? `${(field.state.value * 100).toFixed(1)}% annual` : 'e.g., 0.05 for 5%'}
                                                </p>
                                            </div>
                                        )}
                                    </form.AppField>
